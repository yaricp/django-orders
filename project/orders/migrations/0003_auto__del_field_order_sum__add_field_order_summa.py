...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.sum'
        db.delete_column(u'orders_order', 'sum')

        # Adding field 'Order.summa'
        db.add_column(u'orders_order', 'summa',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Order.sum'
        db.add_column(u'orders_order', 'sum',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Order.summa'
        db.delete_column(u'orders_order', 'summa')
    ...
    models = {
        ...
        u'orders.order': {
            ...
            'summa': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2'}),
