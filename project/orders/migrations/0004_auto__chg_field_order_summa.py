...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.summa'
        db.alter_column(u'orders_order', 'summa', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Order.summa'
        db.alter_column(u'orders_order', 'summa', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))
    ...
    models = {
        ...
        u'orders.order': {
            ...
            'summa': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '9', 'decimal_places': '2'}),
